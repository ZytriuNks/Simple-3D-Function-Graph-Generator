...
// 主函数演示
int main() {
    std::cout << "=== 支持 x, y 变量的表达式求值器 ===" << std::endl;
    std::cout << "支持的运算符: + - * / ^ (幂运算)" << std::endl;
    std::cout << "支持的数学函数: sin, cos, tan, asin, acos, atan, sqrt, ln, log10, exp, abs" << std::endl;
    std::cout << "变量: x, y" << std::endl;
    std::cout << "输入表达式 (输入空行退出): " << std::endl;
